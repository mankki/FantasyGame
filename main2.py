...
class Character:
    ...
    def __str__(self):
        return f"{self.name} the {self.character_type} - Health: {self.health}, Stamina: {self.stamina}, Currency: {self.currency}"
...
class FantasyGame:
    def __init__(self, root):
        ...
        self.treasures = [Item("5 coins", 0, 0, 0, 0, 5, 0, 0), Item("10 coins", 0, 0, 0, 0, 10, 0, 0), Item("20 coins", 0, 0, 0, 0, 20, 0, 0), Item("30 coins", 0, 0, 0, 0, 30, 0, 0), Item("Large Health Potion (+30)", 0, 0, 0, 0, 0, 30, 0), Item("Large Stamina Potion", 0, 0, 30, 0, 0, 0, 0), Item("Fire Ball Spell", 30, 30, 0, 0, 0, 0, 0), Item("Ice Wall Spell", 0, 20, 0, 0, 0, 0, 20)]
        """
        {
            "5 coins": {"damage": 0, "stamina_cost": 0, "stamina_gain": 0, "currency_gain": 5, "health_gain": 0, "shield": 0},
            "10 coins": {"damage": 0, "stamina_cost": 0, "stamina_gain": 0, "currency_gain": 10, "health_gain": 0, "shield": 0},
            "20 coins": {"damage": 0, "stamina_cost": 0, "stamina_gain": 0, "currency_gain": 20, "health_gain": 0, "shield": 0},
            "30 coins": {"damage": 0, "stamina_cost": 0, "stamina_gain": 0, "currency_gain": 30, "health_gain": 0, "shield": 0},
            "Health Potion (+30)": {"damage": 0, "stamina_cost": 5, "stamina_gain": 0, "currency_gain": 0, "health_gain": 30, "shield": 0},
            "Stamina Potion (+30)": {"damage": 0, "stamina_cost": 0, "stamina_gain": 30, "currency_gain": 0, "health_gain": 30, "shield": 0},
            "Fire Ball Spell": {"damage": 20, "stamina_cost": 30, "stamina_gain": 0, "currency_gain": 30, "health_gain": 30, "shield": 0},
            "Ice Wall Spell": {"damage": 20, "stamina_cost": 30, "stamina_gain": 0, "currency_gain": 30, "health_gain": 30, "shield": 20},
        }
        """
    ...
    def start_game(self):
        ...
        if name:
            player_id = 2  # Assign a unique ID, replace with proper logic
    ...
    def process_received_action(self, data):
        ...
        if action_type == "attack":
            ...
            if self.character.shield > 0:
                ...
                self.character.shield = max(0, self.character.shield - damage)
